...
#Server informs OS that given IP, PORT will be used
server_socket.bind((IP, PORT))

#Sever listens for new connections
...
while True:
    ...
    for notified_socket in read_sockets:
        ...
        if notified_socket == server_socket:
            ...
            # Client disconnected before they sent their name
            if user is False:
                continue
